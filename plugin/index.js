/**
 * dsh-telemetry — DSH (DeepSeek Harness) 插件入口。
 *
 ...
 *   宿主集成代码 `import { createRecorder } from "dsh-telemetry/telemetry"`。
 */
...
export function apply(ctx, config = {}) {
  ...
  try {
    ...
    console.warn?.("[dsh-telemetry] skill provider unavailable; CLI and library interfaces remain usable");
  }
  ...
  ctx.effect(
    ...
    "dsh-telemetry skill provider + telemetry flush"
  );
